...
<head>
    ...
    <style>
        ...
        .info  { background: #e8f5e9; border-left: 4px solid #1c6a3d; padding: 12px; margin: 10px 0; }
        .server { background: #fff3cd; border-left: 4px solid #ffc107; padding: 12px; margin: 10px 0; }
        .info_statistik{ background: #e8f5e9; border-left: 4px solid #6a291c; padding: 12px; margin: 10px 0; }
        .info_perpustakaan{ background: #e3f2fd; border-left: 4px solid #2196f3; padding: 12px; margin: 10px 0; }
    </style>
</head>
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Isnaeni Kholifatun"; ?></p>
        ...
        $nama_perpus = "Pepustakaan Universitas ABC";
        $alamat_perpus = "Jl. Raya Tulis Wonosegoro, Bandar, Batang, Jawa Tengah";
